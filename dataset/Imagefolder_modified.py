...
class DatasetFolder(VisionDataset):
    ...
    def __init__(self, root, loader, extensions=None, transform=None, target_transform=None, is_valid_file=None, cached=False, number=None, noise_list=None, get_noise=False):
        ...
        if noise_list != None:
            ...
            ids = np.sort(ids)
            ids = ids[::-1]
            print('Noise Image Number: ', len(ids))
            for i in range(len(ids)):
                # print(samples[ids[i]][0])
                noise.append(samples[ids[i]].copy())
                samples.pop(ids[i])
        ...
        if number != None:
            ...
            print('Using all images, image number: ', len(self.samples))
        if cached == True:
...
class Imagefolder_modified(DatasetFolder):
    ...
    def __init__(self, root, transform=None, target_transform=None,
                 loader=default_loader, is_valid_file=None, cached=False, number=None, noise_list=None, get_noise=False):
